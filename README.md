...
The app targets Android API 36 and has version `1.0.0` / code `1`. Release builds require a local upload key so an unsigned artifact can never be uploaded by mistake.
